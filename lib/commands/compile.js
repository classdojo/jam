...
exports.usage = '\n' +
    ...
    '  --config            Additional require.js optimizer config options.\n' +
...
exports.run = function (settings, _args) {
    ...
    var a = args.parse(_args, {
        ...
        config: {match: ['--config'], value: true }
    });
...
exports.filterPackages = function (cfgpackages, pkgdir, names, callback) {
    async.filter(names, function (n, cb) {
        ...
        if (pkg && pkg.main) {
            ...
            var pt = path.join(pkgdir, n, 'main.js');
            try {
    ...
    install.initDir(opt.settings, opt.cwd, opt, function (err, opt, cfg, pdir) {
        ...
        exports.filterPackages(
            packages, opt.pkgdir, pkgnames, function (valid_names) {
                ...
                if (opt.config) {
                    deepExtend(config, require(path.join(opt.baseurl, opt.config)));
                }
